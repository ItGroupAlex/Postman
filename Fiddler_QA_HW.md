...
Сделать правила:
 ...
 ```
Add rule:
Conditions: URL http://162.55.220.72 
Actions: Update Query Params / Find and raplace (Alex -> Алексей)
```
...
Add rule:
Conditions: URL: http://162.55.220.72 
Actions: Manual Response /
HTTP/1.0 500
Content-Type: application/json
Content-Length: 100
Server: Werkzeug/2.0.1 Python/3.8.10
Date: Mon, 17 Jul 2023 18:51:39 GMT

{"age":"","family":{"children":[["Alex",24],["Kate",12]],"u_salary_1_5_year":8000},"name":"Alex",}
...
Add rule:
Conditions: URL http://162.55.220.72 
Actions: Update Response Body / Find and raplace ("salary":2000, -> Null)
```  
